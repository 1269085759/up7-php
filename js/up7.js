...
function HttpUploaderMgr()
{
	...
	this.Config = {
		...
		//文件夹操作相关
		, "UrlFdCreate"		: "http://localhost:811/up7/db/fd_create.php"
		, "UrlFdUpdate"		: "http://localhost:811/up7/db/fd_update.php"
		, "UrlFdComplete"	: "http://localhost:811/up7/db/fd_complete.php"
		, "UrlFdDel"	    : "http://localhost:811/up7/db/fd_del.php"
		//文件操作相关
		, "UrlCreate"		: "http://localhost:811/up7/db/f_create.php"
		, "UrlUpdate"		: "http://localhost:811/up7/db/f_update.php"
		, "UrlPost"			: "http://localhost:811/up7/db/f_post.php"
		, "UrlComplete"		: "http://localhost:811/up7/db/f_complete.php"
		, "UrlList"			: "http://localhost:811/up7/db/f_list.php"
		, "UrlDel"			: "http://localhost:811/up7/db/f_del.php"
	    //x86
        , ie: {
